...
const NavIcon: React.FC<{ icon: React.ComponentType<React.SVGProps<SVGSVGElement>> }> = ({ icon: Icon }) => (
  <span className="nav-icon relative inline-flex h-10 w-10 items-center justify-center overflow-hidden rounded-xl bg-[rgba(26,32,72,0.85)] text-[rgba(188,210,255,0.85)] shadow-[0_10px_25px_rgba(10,0,40,0.35)]">
